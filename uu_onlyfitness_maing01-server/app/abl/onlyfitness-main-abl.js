...
const Errors = require("../api/errors/onlyfitness-main-error.js");
...
const logger = LoggerFactory.get("OnlyfitnessMainAbl");

class OnlyfitnessMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuOnlyfitness",
        typeCode: "uu-onlyfitness-maing01",
        location: location,
...
module.exports = new OnlyfitnessMainAbl();
