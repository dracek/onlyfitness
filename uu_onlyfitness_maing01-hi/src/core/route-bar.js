...
const RouteBar = createVisualComponent({
  ...
  render(props) {
    ...
    const appActionList = [
      ...
      { children: <Lsi import={importLsi} path={["Menu", "activity"]} />, onClick: () => setRoute("activity") },
      { children: <Lsi import={importLsi} path={["Menu", "challenge"]} />, onClick: () => setRoute("challenge") },
